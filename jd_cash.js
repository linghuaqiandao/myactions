...
function readShareCode() {
  ...
  return new Promise(async resolve => {
    $.get({url: "https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/JD_Cash.json",headers:{
...
function getAuthorShareCode(url = "https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_updateCash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
...
function getAuthorShareCode2(url = "https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_updateCash.json") {
  return new Promise(resolve => {
    $.get({url, headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }, timeout: 200000,}, async (err, resp, data) => {
