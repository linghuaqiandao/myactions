...
!(async () => {
  ...
  res = await getAuthorShareCode('https://github.com/linghuaqiandao/myactions/blob/main/test/zoo.json');
  if (pKHelpAuthorFlag) {
...
function getAuthorShareCode(url = "https://ghproxy.com/https://github.com/linghuaqiandao/myactions/blob/main/test/zoo.json") {
  return new Promise(async resolve => {
      const options = {
          "url": `${url}?${new Date()}`,
          "timeout": 10000,
