...
function getAuthorShareCode() {
  return new Promise(resolve => {
    $.get({url: "https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/bean.json",headers:{
...
function getAuthorShareCode2() {
  return new Promise(resolve => {
    $.get({url: "https://cdn.jsdelivr.net/gh/gitupdate/updateTeam@master/shareCodes/jd_updateBe.json",headers:{
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 13_2_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1 Edg/87.0.4280.88"
      }}, async (err, resp, data) => {
      try {
        if (err) {
