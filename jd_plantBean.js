...
function readShareCode() {
  console.log(`开始`)
  return new Promise(async resolve => {
    $.get({url: "https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/JD_Plant_Bean.json",headers:{
      ...
      try {
        if (err) {
          ...
          $.get({url: `https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/JD_Plant_Bean.json",`, 'timeout': 10000},(err, resp, data)=>{
