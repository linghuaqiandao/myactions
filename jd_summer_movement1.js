...
$.inviteList = [];
$.secretpInfo = {};
$.ShInviteList = ['HcmphKvwI0n8PNTMaatUn9XHzKcL89TUwp_g9Zxscp0Ty2uvQQ0M52CxswxQ5nxMwC_oS4IU3cv5E6U',
...
!(async () => {
  ...
  innerShInviteList = await getAuthorShareCode('https://github.com/linghuaqiandao/myactions/blob/main/test/jd_summer.json');
