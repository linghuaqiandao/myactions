...
!(async () => {
  ...
  await requestAlgo();
  let res = {}, res2 = await getAuthorShareCode("https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/cfd.json")
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/cfd.json')
