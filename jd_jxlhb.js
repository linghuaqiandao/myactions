...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jxhb.json') || [];
...
function getAuthorShareCode(url = "https://ghproxy.com/https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jxhb.json") {
  return new Promise(resolve => {
    const options = {
