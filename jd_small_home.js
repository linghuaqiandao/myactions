...
async function helpFriends() {
  ...
  if (!$.inviteCodes) await updateInviteCodeCDN('https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_updateSmallHomeInviteCode.json');
...
function updateInviteCode(url = 'https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_updateSmallHomeInviteCode.json') {
  return new Promise(resolve => {
...
function updateInviteCodeCDN(url = 'https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_updateSmallHomeInviteCode.json') {
  return new Promise(async resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
