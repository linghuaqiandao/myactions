...
$.ShInviteList = [];
$.innerShInviteList = [
  "HcmphKvwI0n8PNTMaatUn9XHzKcL89TUwp_g9Zxscp0Ty2uvQQ0M52CxswxQ5nxMwC_oS4IU3cv5E6U","HcmphLbwLnbeCsvdRIxyiouMIfWelMYpDrUll4JioaaKMOHrQWQ6zwpO6rl474Nm2XmD-WSZq9WLXkYKYg","HcmphDUGwNIf91Uepph_mh9OJ8Schc1g7cglGtHBvVJQyLPUaSS8Qa98pJ7rOiw","HcmphOutQQqhfIGfCtU633LAWfWyEF1pgYInYZDwaJah8_EzPzDT4poUai3QdBoiin6-0GBysYqkh8B3Jw","HcmphLbwLlbBKtXtV5xmqQlI_hdvlU8Js2sTbggxLYD0IOmhrIGqK0ok7-IkujmlNMX6MZfCaS3uy5oWBg","HcmphOijQwigfICcEbtumuSkN0iHnahCWRqUJP0vrVb1gLSIGTldfS0lXnCaQ84ZshAy5A"
];
$.appid = 'o2_act';
if ($.isNode()) {
...
!(async () => {
  ...
  // 助力
  let res = await getAuthorShareCode('https://github.com/linghuaqiandao/myactions/blob/main/test/jd_summer_SH.json')
  if (!res) {
    ...
    await $.wait(1000)
    res = await getAuthorShareCode('https://github.com/linghuaqiandao/myactions/blob/main/test/jd_summer_SH.json') || []
  }
  let res2 = await getAuthorShareCode('https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_summer.json')
  if (!res2) {
    ...
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://raw.githubusercontent.com/linghuaqiandao/myactions/main/test/jd_summer.json') || []
  }
  if (ShHelpAuthorFlag) {
